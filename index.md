...
title: Wiki Index
updated: 2026-09-14
total_pages: 1135  # 2026-09-14 실측(sources 1043 · entities 52 · concepts 34 · synthesis 2 · domains 4 · queries 0)
total_sources: 1043  # 2026-09-14 실측. 🔴 **배치 13건 중 신규 5 · 중복 8(61.5%)** — raw가 중복 8건을 정확히 탈락시켜 놓고 **그 빈자리를 채운 후보에는 필터를 다시 돌리지 않았다**. 채널별로 쪼개면 결정적: **GitHub 5/5 중복 · HF모델 3/3 중복 · HF논문 0/5**(탈락 0 = 백필 0인 유일한 채널) → [[백필-우회]] 신설. ✅ **09-13 볼트 요청 "성립 조건을 같은 불릿에"는 13/13 완벽 충족** — 타깃 지표는 개선, 감시 안 하던 통제 지표가 조용히 회귀. 🔴 볼트 자기 정정 2건: 09-10 [[MiniCPM5-2B]] "실사용 적다" 반증(DL ×52) · 08-30 [[OpenMontage]] 2주 임계선 결론 오류. 신설 개념 1 · 신설 엔티티 0. 도메인: ai-news 3 · local-llm 1 · slam-3dgs 1(신규분 기준)
---

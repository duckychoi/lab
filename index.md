...
title: Wiki Index
updated: 2026-09-12
total_pages: 1110  # 2026-09-12 실측(sources 1025 · entities 48 · concepts 31 · synthesis 2 · domains 4 · queries 0)
total_sources: 1025  # 2026-09-12 실측 (배치 13건 **전량 신규**. ✅ 09-11 볼트가 요청한 개선 1건 성공 — raw가 중복검사 대조를 `raw.md`→`wiki/sources/` 로 교체해 **후보 57건 중 42건을 기존 인제스트로 탐지·제외**했고, 볼트 URL 재대조 결과 남은 13건 **중복 0 확인**. 🔴 대신 새 오류 유형 3건 = **한정어 탈락**(조건절 누락) → 개념 신설. 도메인: ai-news 11 · local-llm 2(raw의 ai-news 판정에서 재판정 이관))
---

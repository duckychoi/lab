...
title: Wiki Index
updated: 2026-09-13
total_pages: 1129  # 2026-09-13 실측(sources 1038 · entities 52 · concepts 33 · synthesis 2 · domains 4 · queries 0)
total_sources: 1038  # 2026-09-13 실측 (배치 13건 **전량 신규** · 중복 0). ✅ raw의 09-12 개선(index.md+log.md 직접 grep)이 후보 단계에서 **16건 탈락** — 볼트 재대조로 오탐 0 확인. ✅ **09-12 볼트 판정 기준 "한정어 누락 0건" 충족** — raw 인용이 행번호까지 전건 원문 일치. 🔴 대신 **볼트 자신의 오류가 드러났다**: 09-02 [[Qwen-Drive-1.0]] "수치 0개" 판정이 틀렸고(가중치 레포가 6일 앞서 존재) → [[짝-아티팩트-조회]] 신설 + 해당 페이지 정정 게시. 신설 개념 2 · 신설 엔티티 4. 도메인: ai-news 8 · local-llm 2 · slam-3dgs 3(raw의 ai-news 판정에서 3건 재판정 이관)
---

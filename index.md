...
- [[선발창-누락]] — **지표가 며칠에 걸쳐 쌓이는데 선발은 당일에 하면, 늦게 커지는 항목은 영원히 선발되지 않는다.** 🔴 실측: `arxiv:2609.08183`(NeoHorse 모논문) **업보트 421 · 공개 09-08 · 코드 ★535 · 볼트 0히트** — 같은 날 배달된 볼트 1위는 [[Uno]] **19**(22배), 09-18 배치 1위는 36(11.7배). 🎯 **[[DeepSeek-V4.1-Flash]] 의 "공개 후 72시간 다운로드는 지표 아님"(6→244,457, 40,743배)의 업보트 버전**이고, **중복 필터 문제가 아니라 창(window) 문제**다. 🔴 **대가**: 오늘 하네스 4건 중 2건이 그 논문의 프레이밍을 쓴다 — **결과를 받고 원인을 못 받았다.** ⚠️ 업보트 시간 상수 **미실측** *(NEW 2026-09-18)*

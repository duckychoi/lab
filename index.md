...
title: Wiki Index
updated: 2026-08-30
total_pages: 969  # 2026-08-31 실측(sources 909 · entities 35 · concepts 19 · synthesis 2 · domains 4 · queries 0)
...
- [[국소-수리-원리]] — **잘된 부분은 건드리지 말고 틀어진 지점만 고쳐라.** 2026-08-31 배치의 논문 3편 + 서베이 1편이 독립 도달한 원리를 **학습(손실 마스킹)·추론(주입 위치)·평가(정지 조건)** 세 층위로 정리. 전제는 *실패가 수리 가능한 동안 보여야* 하며, 분기점 판정을 생성기와 같은 계열 LLM에 맡기면 **심판 비독립성**에 걸린다 *(NEW 2026-08-31)*
<!-- 아이디어, 이론, 프레임워크 -->

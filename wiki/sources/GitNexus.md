---
title: GitNexus — 코드베이스 Graph RAG 도구
type: source
domain: ai-news
tags: [ai-news, graph-rag, code-analysis, mcp, knowledge-graph, local]
created: 2026-04-29
updated: 2026-04-29
sources: []
reliability: high
...
**허와 실**: 그래프 빌드 초기 비용 존재, 대형 레포에서 인덱싱 시간 검토 필요
**액션**: Claude Code MCP 연동 테스트, [[claude-context]]와 성능 비교

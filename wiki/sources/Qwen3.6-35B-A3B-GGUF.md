---
title: Qwen3.6-35B-A3B-GGUF (unsloth)
domain: ai-news
type: source
source_type: huggingface
url: https://huggingface.co/unsloth/Qwen3.6-35B-A3B-GGUF
date_ingested: 2026-04-22
tags: [llm, gguf, quantization, moe, local-llm, qwen]
---
...
## 핵심 특징
- 35B 파라미터, 3B 활성화 MoE 아키텍처
- GGUF 양자화로 로컬 RAM에서 실행 가능
- unsloth의 최적화 양자화 적용

## 의의
대용량 MoE 모델의 로컬 구동 수요 충족 — 1.1M 다운로드가 입증하는 커뮤니티 수요.
